...
class MainActivity : AppCompatActivity() {
    ...
    private var detector: FoodIdentifier? = null
    ...
    private fun setupEvaluateButton(): Button {
        ...
        evaluateButton.setOnClickListener {
            ...
            // the UI thread.
            detector!!.foodPercentage(croppedBitmap) { foodid ->
                runOnUiThread {
                    setFoodIdentity(foodid)
                }
            }
        }
    ...
    private fun setupResetButton(evaluateButton: Button) {
        ...
        resetButton.setOnClickListener {
            ...
            val capturedImage = findViewById<ImageView>(R.id.captured_image)
            val foodPercentageText = findViewById<TextView>(R.id.food_percentage)
            val foodIdentity = findViewById<TextView>(R.id.food_label)
...
//            val cutenessEvaluationText = findViewById<TextView>(R.id.cuteness_evaluation_text)
            ...
            foodPercentageText.visibility = View.GONE
            foodIdentity.visibility = View.GONE
...
//            cutenessEvaluationText.visibility = View.GONE
    ...
    private fun setLabels(context: Context){
        ...
        val id = context.resources.getIdentifier("labelmap","raw", context.packageName)
...
//        }
    ...
    private fun setFoodIdentity(foodid: Array<Float>) {
        ...
        val resetButton = findViewById<Button>(R.id.reset_button)
        val foodPercentageText = findViewById<TextView>(R.id.food_percentage)
        val foodlabelText = findViewById<TextView>(R.id.food_label)
//        val cutenessPercentageText = findViewById<TextView>(R.id.cuteness_percentage_text)
//        val cutenessEvaluationText = findViewById<TextView>(R.id.cuteness_evaluation_text)
        foodPercentageText.text = getString(R.string.food_percentage, 100* foodid[1])
        //label_map maps the first index (representing food label) to actual food class name
        foodlabelText.text = getString(R.string.food_label, label_map[foodid[0].toInt()])
        resetButton.visibility = View.VISIBLE
        foodPercentageText.visibility = View.VISIBLE
        foodlabelText.visibility = View.VISIBLE
...
//        cutenessEvaluationText.visibility = View.VISIBLE
    ...
    private fun openBackgroundThread() {
        ...
        backgroundThread = HandlerThread("foodid_camera_thread")
